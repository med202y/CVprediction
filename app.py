...
# Prédiction et nom de catégorie
...
# Prédiction et recommandation d'emploi
...
def extract_contact_number_from_resume(text):
    ...
    # Utiliser une expression régulière pour trouver un numéro de contact potentiel
...
def extract_email_from_resume(text):
    ...
    # Utiliser une expression régulière pour trouver une adresse e-mail potentielle
...
def extract_education_from_resume(text):
    ...
    # Liste de mots-clés d'éducation à rechercher
    education_keywords = [
...
def extract_name_from_resume(text):
    ...
    # Utiliser une expression régulière pour trouver un nom potentiel
...
@app.route('/')
def resume():
    # Fournit une interface simple pour téléverser un CV
    return render_template("resume.html")

@app.route('/pred', methods=['POST'])
def pred():
    # Traiter le fichier PDF ou TXT et effectuer la prédiction
    if 'resume' in request.files:
        ...
        if filename.endswith('.pdf'):
            ...
            return render_template('resume.html', message="Format de fichier invalide. Veuillez téléverser un fichier PDF ou TXT.")
        ...
        return render_template("resume.html", message="Aucun fichier de CV téléversé.")
